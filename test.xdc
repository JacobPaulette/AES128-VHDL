...
set_property PACKAGE_PIN M2 [get_ports {input[13]}]
set_property PACKAGE_PIN N2 [get_ports {input[15]}]
set_property PACKAGE_PIN H1 [get_ports {input[5]}]
set_property PACKAGE_PIN N1 [get_ports {input[14]}]
set_property PACKAGE_PIN P3 [get_ports {input[12]}]
...
set_property PACKAGE_PIN N3 [get_ports clock]
...
set_property IOSTANDARD LVCMOS33 [get_ports clear_L]
